import type { ID } from '@/modules/scalar/mod.js';
import type { DateTime } from '@/modules/scalar/mod.js';
import type { EmailAddress } from '@/modules/scalar/mod.js';
import type { NonEmptyString } from '@/modules/scalar/mod.js';
import type { GraphQLResolveInfo, GraphQLScalarType, GraphQLScalarTypeConfig } from 'graphql';
import type { Node as NodeMapper } from '@/modules/node/common/resolver.js';
import type { Todo as TodoMapper } from '@/modules/todo/common/resolver.js';
import type { User as UserMapper } from '@/modules/user/common/resolver.js';
import type { Context } from '@/modules/common/resolvers.js';
