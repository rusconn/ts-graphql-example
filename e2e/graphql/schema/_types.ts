...
export type UserEmailChangeMutation = {
  userEmailChange?:
    | { __typename: "EmailAlreadyTakenError" }
...
export type LoginPasswordChangeMutation = {
  loginPasswordChange?:
...
export type LogoutLoginViewerQuery = {
  viewer?: {
    id: string;
    name?: string | null;
    email?: string | null;
    ...
    todos?: { totalCount?: number | null } | null;
  } | null;
};
...
export type AccountDeleteNodeQuery = { node?: { id: string } | { id: string } | null };
...
export type AccountUpdateNodeQuery = {
  node?:
...
export type LoginPasswordChangeLoginMutation = {
  login?:
    | { __typename: "InvalidInputErrors" }
...
export type LoginPasswordChangeNodeQuery = {
  node?:
    | { __typename: "Todo"; id: string }
    | {
        __typename: "User";
...
export type SignupLoginMutation = {
  login?:
    | { __typename: "InvalidInputErrors"; errors: Array<{ field: string }> }
    | { __typename: "LoginFailedError"; message: string }
    | { __typename: "LoginSuccess"; token: string }
...
export type TodoCreateNodeQuery = {
  node?:
    | {
        __typename: "Todo";
        title?: string | null;
...
export type TodoDeleteNodeQuery = {
  node?:
    | {
        __typename: "Todo";
        title?: string | null;
...
export type TodoStatusChangeMutation = {
  todoStatusChange?:
    | { __typename: "ResourceNotFoundError" }
    | {
...
export type TodoStatusChangeNodeQuery = {
  node?:
    | {
        __typename: "Todo";
        title?: string | null;
...
export type TodoUpdateNodeQuery = {
  node?:
    | {
        __typename: "Todo";
        title?: string | null;
...
export type TokenRefreshNodeQuery = { node?: { id: string } | { id: string } | null };

export type UserEmailChangeNodeQueryVariables = Exact<{
  id: Scalars["ID"]["input"];
}>;

export type UserEmailChangeNodeQuery = {
  node?:
    | { __typename: "Todo"; id: string }
    | {
        __typename: "User";
...
export type UsersQuery = {
  users?: {
    ...
    edges?: Array<{ cursor: string; node?: { id: string } | null } | null> | null;
  } | null;
};
...
export type TodoCreatedAtQuery = {
  node?: { __typename: "Todo"; createdAt?: string | null } | { __typename: "User" } | null;
};
...
export type TodoDescriptionQuery = {
  node?: { __typename: "Todo"; description?: string | null } | { __typename: "User" } | null;
};
...
export type TodoIdQuery = {
  node?: { __typename: "Todo"; id: string } | { __typename: "User"; id: string } | null;
};
...
export type TodoStatusQuery = {
  node?: { __typename: "Todo"; status?: TodoStatus | null } | { __typename: "User" } | null;
};
...
export type TodoTitleQuery = {
  node?: { __typename: "Todo"; title?: string | null } | { __typename: "User" } | null;
};
...
export type TodoUpdatedAtQuery = {
  node?: { __typename: "Todo"; updatedAt?: string | null } | { __typename: "User" } | null;
};
...
export type TodoUserQuery = {
  node?: { __typename: "Todo"; user?: { id: string } | null } | { __typename: "User" } | null;
};
...
export type UserCreatedAtQuery = {
  node?: { __typename: "Todo" } | { __typename: "User"; createdAt?: string | null } | null;
};
...
export type UserEmailQuery = {
  node?: { __typename: "Todo" } | { __typename: "User"; email?: string | null } | null;
};
...
export type UserNameQuery = {
  node?: { __typename: "Todo" } | { __typename: "User"; name?: string | null } | null;
};
...
export type UserTodoQuery = {
  node?: { __typename: "Todo" } | { __typename: "User"; todo?: { id: string } | null } | null;
};
...
export type UserUpdatedAtQuery = {
  node?: { __typename: "Todo" } | { __typename: "User"; updatedAt?: string | null } | null;
};
